...
export async function addSubscriber(newsletterSubscriberData) {
...
//     const response = await fetch(`${firebaseDomain}/comments/${requestData.quoteId}.json`, {
//         method: 'POST',
...
//     const response = await fetch(`${firebaseDomain}/comments/${quoteId}.json`);
//
//     const data = await response.json();
//
//     if (!response.ok) {
